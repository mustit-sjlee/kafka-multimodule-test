package org.example.kafkaproducer1.producerimpl


import org.example.kafkaproducer1.repository.MessageRepository
...
@Component
class KafkaProducer1(val kafkaTemplate: KafkaTemplate<String, Data>)
  : KafkaProducer{
